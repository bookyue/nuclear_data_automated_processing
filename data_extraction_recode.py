...
def filter_data(filename, physical_quantity_name, nuclide_list):
    """
    依据核素名称，筛选数据行
    ...
    dict_df_data = fetch_data_by_filename_and_nuclide_list(filename, physical_quantity_name, nuclide_list)
...
def process(physical_quantity_name, nuclide_list):
    ...
    for filename in filenames:
        # print(filename.name)
        df_nuclide_list = filter_data(filename, physical_quantity_name, nuclide_list)
